...
var ClothingHeading = document.querySelector(".ClothingHeading");
var h2 = document.createElement("h2");
h2.innerText = "Clothing for Men and Women";
ClothingHeading.appendChild(h2);
h2.classList.add("clothSectionHeader");

var AccessoriesHeading = document.querySelector(".AccessoriesHeading");
var h22 = document.createElement("h2");
h22.innerText = "Accessories for Men and Women";
AccessoriesHeading.appendChild(h22);
h22.classList.add("clothSectionHeader");

var clothDiv = document.querySelector(".ClothingCard");
var assessoriesDiv = document.querySelector(".AccessoriesCard");
